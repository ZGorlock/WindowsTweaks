...
set SOURCE_FORMAT=mp4
set TARGET_FORMAT=mp4
set   SUBS_FORMAT=srt

set PROCESS=*.%SOURCE_FORMAT%
set OUT_DIR=out
...
for %%f in (%PROCESS%) do (
	...
	set SOURCE="!fn!.%SOURCE_FORMAT%"
	set   SUBS="!fn!.%SUBS_FORMAT%"
	
	set TARGET="%OUT_DIR%\!fn!.%TARGET_FORMAT%"
